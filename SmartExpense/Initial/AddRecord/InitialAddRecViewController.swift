...
class InitialAddRecViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.keyboardWillHide(note:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
    ...
    func drawContent() {
        ...
        self.customTableView.snp.makeConstraints{ (make)->Void in
            make.edges.equalTo(UIEdgeInsets(top: 70, left: 0, bottom: 0, right: 0))
        }
    }
