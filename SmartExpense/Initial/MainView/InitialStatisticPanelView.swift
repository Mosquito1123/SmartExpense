...
//        self.backgroundColor = UIColor(rgb: 0x8BE6C7)
        self.backgroundColor = UIColor(red: 250.0/255.0, green: 153.0/255.0, blue: 55.0/255.0, alpha: 1.0)
//        self.TopBarView.backgroundColor = UIColor(rgb: 0x8BE6C7)
        self.TopBarView.backgroundColor = UIColor(red: 250.0/255.0, green: 153.0/255.0, blue: 55.0/255.0, alpha: 1.0)

//        self.SummaryPanel.backgroundColor = UIColor(rgb: 0x8BE6C7)
        self.SummaryPanel.backgroundColor = UIColor(red: 250.0/255.0, green: 153.0/255.0, blue: 55.0/255.0, alpha: 1.0)
